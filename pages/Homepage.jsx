...
export const metadata = {
  title:
    "Best Double Sided Tape | Strong, Thin, Transparent double sided tape with Price",
  description:
    "Shop transparent double sided tape, thin double sided tape, strong double sided tape & 3M double sided tape alternatives at best double sided tape price.",
};
...
export default function HomePage() {
  ...
  const slides = [
    {
      ...
      content:
        "GENWIN brings you high-quality double-sided tapes designed to deliver strong, durable, and clean bonding solutions. Whether you're working on simple DIY projects or large-scale industrial tasks, our advanced tapes ensure reliable performance with a professional finish.",
  ...
  const columnsData = [
    {
      id: 1,
      heading: "Faster Assembly Time",
      content:
        "Save time and effort with double-sided tapes that eliminate the need for traditional fasteners like screws or nails. Whether you’re working on construction, packaging, or crafting, the adhesive allows for quick and efficient assembly while maintaining a strong bond.",
    },
    {
      id: 2,
      heading: "Enhanced Aesthetics",
      content:
        "Double-sided tapes provide a clean and invisible bond, making them ideal for applications where appearance matters, such as home décor, displays, and product packaging. Say goodbye to bulky fasteners and ensure a sleek, professional finish.",
    },
    {
      id: 3,
      heading: "Design Flexibility",
      content:
        "Highly adaptable, double-sided tapes bond effortlessly to various materials like metal, wood, glass, and plastic. This versatility makes them suitable for both smooth and uneven surfaces, conforming to unique shapes and sizes for all your project needs.",
    },
    {
      id: 4,
      heading: "Vibration Dampening and Shock Absorption",
      content:
        "Foam-based tapes not only provide a secure bond but also absorb shocks and reduce noise, making them perfect for automotive, electronics, and industrial applications. They help enhance durability while ensuring a quieter, more efficient performance.",
    },
    {
      id: 5,
      heading: "Durable and Multi-Functional Applications",
      content:
  ...
  const usesslides = [
    {
      image:
        "https://www.team-bhp.com/forum/attachments/modifications-accessories/2443958d1682446729-adhesive-tape-use-fit-dashcam-windshield-screenshot_20230425_234719_chrome.jpg",
      heading: "Sensor and Camera Mounting",
      description:
        "In modern vehicles, double-sided tape is used to mount reversing cameras, parking sensors, and ADAS components without damaging paint or structure.",
    },
    {
      image: "/assets/images/uses3.webp",
      heading: " Emblem and Badge Mounting",
      description:
        "Double-sided tapes are used to securely attach brand emblems, model badges, and trim pieces to the vehicle body without drilling or welding.",
    },
    {
      image:
        "https://m.media-amazon.com/images/S/aplus-media-library-service-media/40b31034-0e0e-4b7c-9d57-18b27c2468a4.__CR0,0,970,600_PT0_SX970_V1___.jpg",
      heading: "Weatherstrip and Seal Attachment",
      description:
        "They help bond rubber seals and weatherstrips around doors, windows, and trunks to prevent water and air leaks, ensuring better insulation and comfort.",
    },
    {
      image: "https://i.ebayimg.com/images/g/CKMAAOSwZgJj6bL6/s-l1200.jpg",
      heading: "Interior Panel Fixing",
      description:
        "Used to attach interior trims, dashboard panels, or console components, providing a clean and tool-free installation while reducing rattling and vibration.",
    },
  ];
  ...
  const video = [
    {
      name: "Abc",
      videoUrl:
        "https://www.globalfpo.com/videos/events/manchester-19-sep-23.mp4",
    },
  ];
        ...
        <div className="max-w-8xl mx-auto ">
          <div className="grid grid-cols-1 lg:grid-cols-1 ">
            ...
            <div className="py-4 rounded-lg flex flex-col justify-between">
              <h2
                className={` mb-4 text-090909 text-30  lg:text-40 xl:text-40 font-[600] text-center ${platypi.className}`}
              >
                <span
                  className={`text-primary text-30  lg:text-40 xl:text-40 font-[600] ${platypi.className}`}
                >
                  Listing
                </span>{" "}
      ...
      >
        <div className="max-w-7xl mx-auto p-5 py-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-0 rounded-lg ">
            <h2
              className={`text-30 lg:text-40 xl:text-40 font-[400] text-start ${platypi.className} text-090909`}
            >
              <span
                className={`text-primary text-30  lg:text-40 xl:text-40 font-[400] ${platypi.className}`}
              >
                Benefits
              </span>{" "}
              of Double Sided Tape
